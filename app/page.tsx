      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <section className="text-center">
          ...
          <p className="text-xl text-neutral-600 mb-8 max-w-2xl mx-auto">
            Join thousands of developers who are already using obfuscated
            TailwindCSS in production.
          </p>
          <div className="flex gap-4 justify-center">
            <Button size="lg">Start Using It Now</Button>
            <a
              href="https://github.com/ui-layouts/Obfuscated-tailwindcss"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 border border-neutral-300 text-neutral-700 hover:bg-neutral-50 transition-colors"
            >
              View on GitHub
            </a>
          </div>
